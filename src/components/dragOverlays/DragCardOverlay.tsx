...
function DragCardOverlay({ card }: CardProps) {
  ...
  return (
    <li
      ...
      {...attributes}
      {...listeners}
      className="h-24 w-full overflow-hidden p-4 flex flex-col gap-2 bg-gray-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border-2  border-neutral-700">
