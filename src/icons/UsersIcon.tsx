...
export function UsersIcon({ isActive }: NavbarIcon) {
  return (
    <svg
      width="32"
      height="32"
      className={navbarIconStyle(isActive)}
      viewBox="0 0 24 24"
      fill="none">
      <circle cx="9.00098" cy="6" r="4" fill="inherit" />
      <ellipse cx="9.00098" cy="17.001" rx="7" ry="4" fill="inherit" />
      <path
